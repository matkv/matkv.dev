...
This is why I've decided to start actually working on my **openings**. I want to find at least one opening for white and one for black on which I can focus and really learn well. My notes while learning the openings can be found [here](https://matkv.dev/notes/chess-openings).
